...
%   
%   [shape_feature,local_feature,displacement_vector] = bounds2localfeature(encoded_shape_feature,bounding_box,image)
...
%   box. Also this is centered in the image domain. This function returns
%   also the displacement vector calculated to center the image.
%
