\subsection{Computer Vision}
    ...
    \begin{frame}
        ...
        \begin{columns}[onlytextwidth]
            \column{0.5\textwidth}
                \includegraphics[width=\textwidth]{graphics/computervision/alpha-shape-points}
            \column{0.5\textwidth}
                \includegraphics[width=\textwidth]{graphics/computervision/alpha-shapes}
        \end{columns}
        \begin{description}
            \item<2-> \begin{theorem}[Topologically correct image segmentation]
