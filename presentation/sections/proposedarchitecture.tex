...
\begin{frame}
    ...
    \begin{columns}
        \column{.4\textwidth}
            \centering
            \only<1> {\localcolumn{ForestGreen}{black}{black}{black}{black}{black}}
            \only<2-5> {\localcolumn{black}{ForestGreen}{black}{black}{black}{black}}
            \only<6-7> {\localcolumn{black}{black}{ForestGreen}{black}{black}{black}}
            \only<8-9> {\localcolumn{black}{black}{black}{ForestGreen}{black}{black}}
            \only<10> {\localcolumn{black}{black}{black}{black}{ForestGreen}{black}}
            \only<11> {\localcolumn{black}{black}{black}{black}{black}{ForestGreen}}
        \column{.6\textwidth}
            \only<1> {
                \begin{itemize}
            ...
            \only<5> {
                \centering
                \includegraphics[width=.45\linewidth]{graphics/architecture/act_net_out}
                \includegraphics[width=.45\linewidth]{graphics/architecture/act_net_hope_out}
            }
            \only<6-7> {
                \begin{itemize}
