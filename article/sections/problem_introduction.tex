...
Example:
    ...
    \subsection{Defect analysis}\label{subsection:defects}
        ...
        \subsubsection{Defect class No.1}\label{section:defect-class-1}
            ...
            \end{figure}
            \par{
                However, it is a glaring example of burst defect, in fact, it is reasonable to expect such defect to be repeated multiple times on the same surface, as deducible from the histogram in \emph{Figure \ref{fig:nregions-1}}.
            }
            \begin{figure}
            ...
            \end{figure}
            \par{
                An example of surface with a burst of class No.1 defects is visible in \emph{Figure \ref{fig:defects:surface-1}}. The shape distribution of the defect is illustrated in \emph{Figure \ref{fig:defects:shape-1}}.
            }
            \par{
    ...
    \subsection{Dataset considerations}
        ...
        \par{
            In \emph{Figure \ref{fig:defects:representation-original}} the relative representation of the classes in the original dataset is reported. It is patent that class No.3 is far more represented then the other defect classes, and the number of surfaces with at least a defect of this class is nearly tantamount the number of flawless surfaces.
        }
        \begin{figure}
        ...
        \end{figure}
        \par{
            In \emph{Figure \ref{fig:defects:combinations}} images was grouped in mutually exclusive subsets, based on the combination of defects in the pictured surface.
        }
        \par{
            Since skewed dataset lessen the effectiveness of machine learning algorithms, especially in predicting minority class examples, data augmentation was performed only on those classes or combinations of classes with fewer elements.
        }
        \begin{figure}
