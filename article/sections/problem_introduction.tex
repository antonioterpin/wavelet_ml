\section{Steel surfaces defect detection}
    \subsection{Problem statement}
        ...
        \end{figure}
        \par{
            The surfaces may have more disjunct defective areas, and there are four defective classes, described in \emph{Section \ref{subsection:defects}}.
        }
        \par{
...
Example:
    ...
    \subsection{Defect analysis}\label{subsection:defects}
        ...
        % }
        \subsubsection{Defect class No.1}\label{section:defect-class-1}
            \par{
                the first type of defects has not been classified into one of the classes found in literature, yet.
            }
            \begin{figure}
                ...
                \caption{Steel surface with defect class No.1.}\label{fig:defects:surface-1}
            \end{figure}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth]{graphics/defects/nregions-class1}
                \caption{Number of defects of class No.1 per defective surface.}\label{fig:nregions-1}
            \end{figure}
            \par{
                However, it is a glaring example of burst defects. In fact, it is reasonable to expect such defect to be repeated multiple times on the same surface, as deducible from the histogram in \emph{Figure \ref{fig:nregions-1}}.
            }
            \begin{figure}
                \includegraphics[width=\linewidth]{graphics/defects/class1shape}
                \caption{Shape distribution for defect class No.1.}\label{fig:defects:shape-1}
            \end{figure}
            \begin{figure}
                \centering
                ...
                \caption{Defect class No.1 dimensions distribution.}\label{fig:defects:gaussian-1}
            \end{figure}
            \par{
                An example of surface with a burst of class No.1 defects is visible in \emph{Figure \ref{fig:defects:surface-1}}. The shape distribution of a single defect is illustrated in \emph{Figure \ref{fig:defects:shape-1}}. This is drawn by super-position of all the defects of the same type, centered in the middle of the figure, and counting the relative frequencies of each pixel.
            }
            \begin{table}
                \centering
                \normalsize
        ...
        \subsubsection{Defect class No.2}\label{section:defect-class-2}
            \par{
                defects of class No.2 usually appear near the transversal edge. Hence, they are probably edge laminations, since they are also visually similar.
            }
            \begin{figure}
                ...
                \caption{Steel surface with defect class No.2.}\label{fig:defects:surface-2}
            \end{figure}
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth]{graphics/defects/nregions-class2}
                \caption{Number of defects of class No.2 per defective surface.}\label{fig:nregions-2}
            \end{figure}
            \par{
                These defects are local, since they are usually near the edge. Indeed, from the histogram in \emph{Figure \ref{fig:nregions-2}} is visible that they occur only a small limited number of times on the same surface.
            }
            \begin{figure}
                \includegraphics[width=\linewidth]{graphics/defects/class2shape}
                \caption{Shape distribution for defect class No.2.}\label{fig:defects:shape-2}
            \end{figure}
            \begin{figure}
                \centering
                ...
                \caption{Defect class No.2 dimensions distribution.}\label{fig:defects:gaussian-2}
            \end{figure}
            \par{
                In \emph{Figure \ref{fig:defects:surface-2}}, an example of surface with a defect of this type is shown. The shape distribution of the defect is illustrated in \emph{Figure \ref{fig:defects:shape-2}}.
            }
            \begin{table}
                \centering
                \normalsize
        ...
        \subsubsection{Defect class No.3}\label{section-defect-class-3}
            \par{
            ...
            \begin{figure}
                ...
                \caption{Steel surface with defect class No.3.}\label{fig:defects:surface-3}
            \end{figure}
            \par{
                Defects of class No.3 are probably rolling defects, in particular their repetitive pattern along the centreline is a symptom of \emph{zipper cracks}, i.e. centre line cracking. This is another glaring example of burst defect.
            }
            \begin{figure}
                \centering
                \includegraphics[width=\linewidth]{graphics/defects/nregions-class3}
                \caption{Number of defects of class No.3 per defective surface.}\label{fig:nregions-3}
            \end{figure}
            \par{
                The hypothesis of transversality of the presence of a defect of class No.3 over the surface is supported by the histogram in \emph{Figure \ref{fig:nregions-3}}. However, as extrapolated from a visual analysis (as an example, consider \emph{Figure \ref{fig:defects:surface-3}}), many defects of class No.3 are encoded together, since they are very near one another. Hence, many of these are considered as an atomic region.
            }
            \begin{figure}
                \includegraphics[width=\linewidth]{graphics/defects/class3shape}
                \caption{Shape distribution for defect class No.3.}\label{fig:defects:shape-3}
            \end{figure}
            \begin{figure}
                \centering
                ...
                \caption{Defect class No.3 dimensions distribution.}\label{fig:defects:gaussian-3}
            \end{figure}
            \par{
        ...
        \subsubsection{Defect class No.4}\label{section-defect-class-4}
            \begin{figure}
            ...
            \begin{figure}
                ...
                \caption{Defect class No.4 dimensions distribution.}\label{fig:defects:gaussian-4}
            \end{figure}
            \par{
                An example of surface affected by defects of class No.4 is illustrated in \emph{Figure \ref{fig:defects:surface-4}}. A single defect of class No.4 (i.e. a single crack) has usually the shape described in \emph{Figure \ref{fig:defects:shape-4}}.
            }
            \begin{table}
                \centering
                \normalsize
    ...
    \subsection{Dataset considerations}
        ...
        \par{
            In \emph{Figure \ref{fig:defects:representation-original}} the relative representation of the classes in the original dataset is reported. It is patent that class No.3 is far more represented then the other defective classes, and the number of surfaces with at least a defect of this class is nearly tantamount the number of flawless surfaces.
        }
        \begin{figure}
        ...
        \end{figure}
        \par{
            In \emph{Figure \ref{fig:defects:combinations}} images were grouped in mutually exclusive subsets, based on the combination of defects in the pictured surface.
        }
        \par{
