    ...
    \subsection{Defect analysis}\label{subsection:defects}
        ...
        \subsubsection{Defect class \#1}\label{section:defect-class-3}
            ...
            \begin{figure}
                ...
                \caption{Defect class \#1 size are drawn from a bivariate lognormal distribution.}\label{fig:defects:gaussian-1}
            \end{figure}
            \par{
            ...
            \par{
                Defect \#1 dimensions are shown to be random variables drawn from a lognormal distribution in \ref{fig:defects:gaussian-1}.
            }
        \subsubsection{Defect class \#2}
            ...
            \begin{figure}
                ...
                \caption{Defect class \#2 size are drawn from a bivariate lognormal distribution.}\label{fig:defects:gaussian-2}
            \end{figure}
            \par{
            ...
            \par{
                The bivariate lognormal distribution of the shape size is shown in \ref{fig:defects:gaussian-2}.
            }
        \subsubsection{Defect class \#3}
            ...
            \begin{figure}
                ...
                \caption{Defect class \#3 size are drawn from a bivariate lognormal distribution.}\label{fig:defects:gaussian-3}
            \end{figure}
            \par{
        ...
        \subsubsection{Defect class \#4}
            ...
            \begin{figure}
                ...
                \caption{Defect class \#4 size are drawn from a bivariate lognormal distribution.}\label{fig:defects:gaussian-4}
            \end{figure}
            \par{
