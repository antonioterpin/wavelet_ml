\section{Detector}\label{section:region_proposals}
    ...
    \subsection{Edge detection}\label{subsection:contour_detection}
    	...
    	\begin{figure} 		  
    		...
    		\vskip .05cm
    		\caption{Output of the edge detector on a sample image using different thresholds $(T_{low},T_{high})$. From top to bottom: $(30,50)$, $(60,100)$ and $(100,150)$. Standard parameters of the Kovesi algorithm were used.}
...
bounding_box =  | maxX maxY |
        ...
        \begin{figure} 		  
    		...
    		\vskip .05cm
    		\caption{ROIs and relative bounding boxes obtained on an example image.}
