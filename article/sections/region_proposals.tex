...
bounding_box =  | maxX maxY |
    	...
    	\par{
    		In \emph{Figure \ref{fig:segmentation-bb-example}} examples of ROIs and bounding boxes obtained from a surface image can be found.
    	}
    	\begin{figure} 		  
    		\includegraphics[width=\linewidth]{graphics/architecture/detector-ex}
    		...
    		\vskip .05cm
    		\caption{ROIs and bounding boxes obtained on a example image using manually-tuned parameters.}
